        ...
        <div>
            ...
            <MainWrapper style={{gap:'40px'}}>
                ...
                <S.SecondAdminDivWrapper style={{width:'100%'}}>
                    ...
                    <AdminDiv height='117px' style={{cursor:'pointer', flex:'1'}} onClick={()=>navigate(`${location.pathname}/pointManage`,{
                        state : {
                            userInfo : {
                                nickname: "가지",
                                email: "comatching@catholic.ac.kr",
                    ...
                    })}><S.TitleDiv>포인트 조정</S.TitleDiv><S.SubText>포인트 수동조정</S.SubText></AdminDiv>
